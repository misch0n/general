...
(function (root, factory) {
  ...
  var CATEGORIES_EXP = [
    ...
    { key: 'sixes',         label: '6',           group: 'upper' },
    { key: 'twoKind',       label: '2x',          group: 'lower' },
    { key: 'twoPair',       label: '2x2',         group: 'lower' },
    { key: 'threeKind',     label: '3x',          group: 'lower' },
    { key: 'fourKind',      label: '4x',          group: 'lower' },
    { key: 'fullHouse',     label: 'фул хаус',     group: 'lower' },
    { key: 'smallStraight', label: 'малка кента',  group: 'lower' },
  ...
  var NOUNS = [
    { w: 'Пишон', g: 'm', gv: { f: 'Пишка', n: 'Пишленце' } }, { w: 'Петел', g: 'm', gv: { f: 'Кокошка', n: 'Пиленце' }, b: '2-3' }, { w: 'Краставица', g: 'f' },
    { w: 'Тиква', g: 'f' }, { w: 'Мотика', g: 'f' }, { w: 'Чорап', g: 'm' },
    { w: 'Баклава', g: 'f' }, { w: 'Магаре', g: 'm', gv: { f: 'Магарица', n: 'Магаренце' }, b: '3-4' }, { w: 'Кашкавал', g: 'm' },
    { w: 'Лопата', g: 'f' }, { w: 'Бухал', g: 'm', gv: { f: 'Бухалица', n: 'Бухалче' }, b: '4-5' }, { w: 'Геврек', g: 'm' },
    ...
    { w: 'Жребец', g: 'm', nsfw: true }, { w: 'Хуй', g: 'm', gv: { f: 'Хуйка', n: 'Хуйче' }, nsfw: true, b: '0-1' }, { w: 'Кур', g: 'm', nsfw: true }, { w: 'Изклесяк', g: 'm', nsfw: true },
  ...
  var EPIC_NOUNS = [{ w: 'Великан', g: 'm', gv: { f: 'Великанка', n: 'Великанче' }, b: '3-4' }, { w: 'Дракон', g: 'm', gv: { f: 'Драконка', n: 'Драконче' }, b: '1-2' },
    { w: 'Крал', g: 'm', gv: { f: 'Кралица', n: 'Кралче' }, b: '2-3' }, { w: 'Бог', g: 'm', gv: { f: 'Богиня', n: 'Богче' }, b: '1-2' }];
